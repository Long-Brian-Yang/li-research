...
![Li–Cl RDF（三モデル、600 K）](plots/Li3YCl6_LiCl_RDF_600K_all_models.png)

Li 周囲の局所配位環境を示す。第一ピークの位置は平均 Li–Cl 距離、ピーク幅は熱振動と局所構造分布を反映する。

![Y–Cl RDF（三モデル、600 K）](plots/Li3YCl6_YCl_RDF_600K_all_models.png)

ハライド骨格側の局所環境を比較する図であり、Y–Cl 骨格が MD 中に維持されているかを確認する。

![Cl–Cl RDF（三モデル、600 K）](plots/Li3YCl6_ClCl_RDF_600K_all_models.png)

陰イオン部分の秩序と熱的な広がりを示す。高温でのピーク幅の変化は熱振動の増加に対応する。

![Li–Cl 配位数（三モデル、600 K）](plots/Li3YCl6_LiCl_coordination_600K_all_models.png)
