...
This record describes the GPUMD/NEP89 screening runs for Direction 2:
...
│       ├── *_msd_300K.csv
│       └── job_8439212/      # raw trajectory; not committed
└── reusable Python analysis: ../../src/li_research/analysis/gpumd/
```

The raw 300 K trajectories are approximately 192 MB and remain in the local
TSUBAME `results/` output rather than being committed to GitHub. The
...
analysis in [`window_sensitivity_300K_2x2x4.csv`](../../../results/gpumd_nep89/300K_2x2x4/window_sensitivity_300K_2x2x4.csv).
The primary fit window, (R^2), and Nernst–Einstein estimate are stored in
[`summary_300K_2x2x4.csv`](../../../results/gpumd_nep89/300K_2x2x4/summary_300K_2x2x4.csv).
...
The full all-atom `dump.xyz` files are kept in the local/TSUBAME results area and
are not committed to GitHub. For reproducible MSD re-analysis, Li-only
unwrapped trajectories are exported as CSV:

- [`Li₃YCl₆_01 Li positions`](../../../results/gpumd_nep89/300K_2x2x4/Li3YCl6_01_Li_unwrapped_300K.csv)
- [`Li₃YCl₆_02 Li positions`](../../../results/gpumd_nep89/300K_2x2x4/Li3YCl6_02_Li_unwrapped_300K.csv)
- [`Li₃YCl₆_03 Li positions`](../../../results/gpumd_nep89/300K_2x2x4/Li3YCl6_03_Li_unwrapped_300K.csv)
- [`LiNbOCl₄ Li positions`](../../../results/gpumd_nep89/300K_2x2x4/LiNbOCl4_Li_unwrapped_300K.csv)
