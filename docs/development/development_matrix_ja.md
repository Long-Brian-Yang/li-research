...
- **方向 1：機械的コンプライアンス** —— `E <30 GPa`。Hu 2023、Hu 2026 に対応。
- **方向 2：高伝導構造** —— P6₃/m、空孔/相転移、mixed-anion、3D migration network。現在の主線。
- **方向 3：低コスト化学空間** —— Li–Zr–Al–O–Cl などの rare-element-free 系。Wang 2021、Hu 2023、Hu 2026 に対応。

Li & Du 2025 は Review であり、3方向を統合評価する枠組みを与えるため、単一方向には分類しない。
