...
|材料・段階|文献との対応|主要結論|
|---|---|---|
|MACE–NEPベンチマーク|同一の旧LZOC構造と対応するMD段階|NEP89は複数材料の長時間計算に必要な計算速度を与え、精度は後続の文献比較で評価した。|
...
4化学系・5作製ルートを含む。新旧LZOCは同じ公称組成である。LZOC／LSZCを酸素含有ハロゲン化物の主線とし、Li₃PS₄で硫化物ガラス、LiPONで酸窒化物網目へ比較を拡張した。結晶Li₃YCl₆／LiNbOCl₄はそれに先行する基準ベンチマークとして位置づける。
...
|旧LZOC|旧候補3、600／700／800／900 K；600 Kは50 ps NPT＋200 ps NVT|材料別文献比較に先行する方法・計算効率ベンチマーク|
