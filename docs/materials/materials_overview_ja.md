...
a–cは300 ps全体から求めた全時間原点平均・全系重心補正Li MSDを0–100 psで表示し、網掛けと破線は20–80 psフィットを示す。dはその傾きと[Hussain2024](https://doi.org/10.1038/s41524-024-01346-y)補足Table 4を比較する。文献の±は原報のまま示し、2 fs系列のみ掲載する。
