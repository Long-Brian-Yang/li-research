...
![LSZC最新MSDと文献比較](../../results/plots/amorphous/18_LSZC_endpoint_transport.png)
...
![LSZC最新部分RDF](../../results/plots/amorphous/19_LSZC_endpoint_RDF.png)
...
![LSZC最新配位数と移動度](../../results/plots/amorphous/20_LSZC_endpoint_mobility.png)
...
|材料・項目|現在の結果|追加計算|
|---|---|---|
|LSZC|最新320／350 K・300 psのMSD、伝導度、RDF、移動度を文献と比較済み|有効なNEP E_aなし。350 K準備密度の不確かさは残る。新規投入なし。|
...
最新LSZC端点のproductionと解析は完了した。本更新で新規MD／DFTを投入していない。
