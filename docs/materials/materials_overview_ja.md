...
300と500 Kはこの時間範囲でsubdiffusiveであり、勾配から得た$D$と伝導度は条件付き診断値である。700と900 Kで最も明瞭な拡散領域が得られた。

![Li3PS4のLi拡散とホスト骨格ダイナミクス](figures/06_LPS_reference.png)

パネルaはNEP89とChenの**DeePMDガラスMD**を比較し、実験またはAIMDの自己拡散係数ではない。白抜き記号はsubdiffusiveな300および500 Kの診断値、結線した塗りつぶし記号は拡散が解像された700および900 Kを示す。パネルbでは、80 ps遅延のP／S MSDが300 Kの0.088／0.145 Å²から900 Kの5.13／12.20 Å²へ増大する。

|T (K)|Chenガラス$D$ (cm²/s)|NEP89／Chen|解釈|
|---:|---:|---:|---|
|300|1.186×10⁻⁹|45.5|NEP89がsubdiffusiveであり定量比較しない|
|500|9.350×10⁻⁸|4.50|subdiffusiveで絶対値は条件付き|
|700|1.524×10⁻⁶|5.20|高温の拡散比較が可能|
|900|9.106×10⁻⁶|3.37|骨格運動を伴う高温比較|

500／700／900 Kの診断回帰は$E_a=0.4189$ eV、$R^2=0.99784$で、従来作製の0.3795 eVよりChenの0.47 eV注記に近い。ただし500 Kの$\alpha=0.535$で、明瞭な拡散温度が二点だけなので、正式な活性化エネルギーとはしない。[Mirmira 2021](https://doi.org/10.1039/D1TA02754A)のボールミル非晶LPSは293.15 Kで約0.35 mS/cmを示すが、この巨視的伝導度は上表の条件付き300 K Nernst–Einstein値と直接比較しない。
...
**Li₃PS₄の結論：** 現在の独立作製ガラスは、輸送解析前に選定され、現行比較としてより明確であるため主図を置換した。NEP89は局所PS4幾何と温度上昇に伴うLi運動の増大を再現するが、Chenガラスの拡散絶対値は再現しない。300と500 Kは未解像であり、室温外挿は行わない。
...
|Li₃PS₄|輸送解析前に選定した独立ガラスについて300／500／700／900 Kを解析し、主図・構造指標・文献比較を置換|直ちに再計算しない。300／500 Kは未解像とし、700／900 Kだけを高温比較に用いる。|
...
|Li₃PS₄|512：Li192P64S256|現行独立ガラスの300／500／700／900 K各200 psを遠隔解析済み|300／500 Kは亜拡散的；高温DはDeePMD基準を上回り、900 K骨格運動も大きい|
