...
![LSZC四温度部分RDF](figures/19_LSZC_four_temperature_RDF.png)

四温度とも最終輸送図と同じ代表軌跡を用い、productionの100–300 psを1 ps間隔で平均した。320／330／340 KはR2、350 KはR1であり、RDFのために別の軌跡を選んでいない。
...
![Li3PS4文献構造比較](figures/07_LPS_structural_comparison.png)
