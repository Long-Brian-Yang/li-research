#!/usr/bin/env bash
# Two 600 K LiPON repeats with 600 ps NVT production.
#$ -cwd
#$ -l gpu_1=1
#$ -l h_rt=1:00:00
#$ -N lipon600_long
...
case "${SGE_TASK_ID:?}" in
  1) REP=4; SEED=60009154 ;;
  2) REP=5; SEED=60009155 ;;
  *) exit 2 ;;
esac
...
# Remove stored velocities before assigning the independent seed.
